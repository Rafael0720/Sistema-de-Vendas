 ...
 * @author Rafael Godoy
 */
public class FrmVendasContaRecLiq extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbContasRecLiq = new javax.swing.JTable();
        ...
        tbContasRecLiq.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        tbContasRecLiq.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbContasRecLiq.setRowHeight(20);
        tbContasRecLiq.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbContasRecLiqMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbContasRecLiq);
        if (tbContasRecLiq.getColumnModel().getColumnCount() > 0) {
            tbContasRecLiq.getColumnModel().getColumn(0).setPreferredWidth(15);
            tbContasRecLiq.getColumnModel().getColumn(1).setPreferredWidth(25);
            tbContasRecLiq.getColumnModel().getColumn(2).setPreferredWidth(150);
            tbContasRecLiq.getColumnModel().getColumn(6).setPreferredWidth(50);
        }
            ...
            .addGroup(pnl_clienteLayout.createSequentialGroup()
                ...
                .addGroup(pnl_clienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnl_clienteLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtPlano, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jLabel15)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtOrigem, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(pnl_clienteLayout.createSequentialGroup()
    ...
    private void btnApagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApagarActionPerformed
        ...
        if (botao == "novo" || botao == "editar") {
            ...
            if (origem.equals("Requisição")) {
                ...
                DefaultTableModel tbContas = (DefaultTableModel) tbContasRecLiq.getModel();
    ...
    private void tbContasRecLiqMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbContasRecLiqMouseClicked

        if (evt.getClickCount() == 1) {

            //pega na tabela, o id da linha que foi selecionada e preenche os campos com os dados referente a esse id.
            String id = tbContasRecLiq.getValueAt(tbContasRecLiq.getSelectedRow(), 0).toString();
            idlinha = tbContasRecLiq.getSelectedRow();
    ...
    }//GEN-LAST:event_tbContasRecLiqMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmVendasContaRecLiq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmVendasContaRecLiq().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTable tbContasRecLiq;
